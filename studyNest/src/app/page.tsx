  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <main>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="#features"
                  className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg text-lg font-bold hover:border-gray-400 hover:bg-gray-50 transition inline-flex items-center justify-center"
                >
                  Learn More
                </Link>
              </div>
        ...
        {/* Features Section */}
        <div id="features" className="bg-white py-20 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900">Why StudyNest?</h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="bg-gradient-to-br from-[#f4fafd] to-[#eaf4fa] rounded-xl p-8 border border-[#bfdced] hover:shadow-lg transition">
                ...
                <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Real‑Time Updates</h3>
              ...
              {/* Feature 2 */}
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-8 border border-green-200 hover:shadow-lg transition">
                <div className="flex justify-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Reliable Data</h3>
                <p className="text-gray-700 text-center">
              ...
              <div className="bg-gradient-to-br from-[#f4fafd] to-[#eaf4fa] rounded-xl p-8 border border-[#bfdced] hover:shadow-lg transition">
                ...
                <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Community Driven</h3>
                <p className="text-gray-700 text-center">
        ...
        <div className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to find your study space?</h2>
